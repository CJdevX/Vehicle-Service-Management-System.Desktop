...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(java.awt.Component parent, Type type, Location location, String message) {
       // this.fram = fram;
        this.fram = parent instanceof Frame ? (Frame) parent : (Frame) SwingUtilities.getWindowAncestor(parent);
        this.type = type;
